...
class Problem(FlaskApp):
        python_version='3'
        files = [File("app/config.py"),File("app/__init__.py"),File("app/helpers.py"),File("app/models.py"),File("app/routes.py"),File("app/templates/base.html"),File("app/templates/base.html"),File("app/templates/admin.html"),File("app/templates/create.html"),File("app/templates/denied.html"),File("app/templates/index.html"),File("app/templates/list.html"),File("app/templates/login.html"),File("app/templates/register.html"),File("app/templates/404.html")]
        flag = ""
        
        def generate_flag(self, random):
                flag = "Not_another_SQL_please_"
