...
PrivateChatLoader.prototype.showPrivateChatSections = function(){
    this.togglePrivateChatSections(true);
};
PrivateChatLoader.prototype.hidePrivateChatSections = function(){
    this.togglePrivateChatSections(false);
};
PrivateChatLoader.prototype.togglePrivateChatSections = function(set){
