...
ServerMessageController.prototype.preferred_games = function(response) {
    ...
    {
        Dashboard.gameFilters.findCache('.dynamic_preferred_games_holder').find('.preferred_game_filter').remove();
        $.each(response.preferred_games, function(i, preferred_game){
            preferred_game = new PreferredGame(preferred_game);
        ...
        let onFilters = Dashboard.gameFilters.findCache('.dynamic_preferred_games_holder').find('.preferred_game_filter.on');
